...
export default function Modal({ onClose, preset = '' }) {
  ...
  const submit = () => {
    ...
    const msg = [
      `Hi Dr. Saurabh, I'd like to book a consultation.`,
      `Name: ${form.name}`,
      `Phone: ${form.phone}`,
    ...
    setStep('success')
    setTimeout(() => {
      window.open(`https://wa.me/918275757171?text=${encodeURIComponent(msg)}`, '_blank')
    }, 1200)
  }
        ...
        {step === 'form' ? (
          ...
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            <div style={{
              ...
              background: 'rgba(36,113,168,.15)', border: '2px solid var(--sage)',
            ...
            <p style={{ color: 'var(--on-cream-65)', fontSize: '.9rem' }}>
              Redirecting you to WhatsApp to connect with Dr. Saurabh…
            </p>
          </div>
        )}
      </div>
