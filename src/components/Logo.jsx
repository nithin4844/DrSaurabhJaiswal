export default function Logo({ size = 44 }) {
  ...
  return (
    <svg
      ...
      aria-label="Dr. Saurabh Jaiswal Skin & Hair Clinic logo"
    >
      {rays.map((d, i) => <path key={i} d={d} fill="#1A3A5C" />)}
      <circle cx={cx} cy={cy} r="18" fill="#1A3A5C" />
      <circle cx={cx} cy={cy} r="12" fill="#2471A8" />
