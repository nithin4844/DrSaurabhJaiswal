    ...
    <>
      <header className={`nav${scrolled ? ' scrolled' : ''}`} role="banner">
        <div className="nav__inner">
          <a href="#" className="nav__logo" aria-label="Dr. Saurabh Jaiswal Skin & Hair Clinic">
            <div className="logo-bubble"><BrandLogo size={52} /></div>
            <div className="nav__logo-text">
              <span className="nav__logo-name">Dr. Saurabh Jaiswal</span>
              <span className="nav__logo-sub">Skin &amp; Hair Clinic · Ramdaspeth, Nagpur</span>
            </div>
          </a>
          ...
          <div className="nav__actions">
            <a href="tel:+918275757171" className="nav__phone">
      ...
      <div className={`drawer${open ? ' open' : ''}`} aria-hidden={!open}>
        ...
        <div className="drawer__foot">
          <a href="tel:+918275757171" className="drawer__link">
            <i className="fa-solid fa-phone" /> +91 82757 57171
          </a>
